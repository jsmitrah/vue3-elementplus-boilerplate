...
!(function (t, e) {
  ...
  function n(t, e) {
    (this.component = t), (this.elt = e), (this.module = { exports: {} });
  }
  function i(t, e) {
    (this.component = t), (this.elt = e);
  }
  ...
  function r(t) {
    var e = t.match(/(.*?)([^/]+?)\/?(\.vue)?(\?.*|#.*|$)/);
    return { name: e[2], url: e[1] + e[2] + (void 0 === e[3] ? '/index.vue' : e[3]) + e[4] };
  }
  function u(t, e) {
  ...
  return (
    (e.prototype = {
      withBase: function (t) {
        ...
        if (this.component.baseURI) {
          (e = document.createElement('base')).href = this.component.baseURI;
      ...
      scopeStyles: function (t, e) {
        ...
        try {
          ...
          if (e instanceof DOMException && e.code === DOMException.INVALID_ACCESS_ERR)
            return (
              (t.sheet.disabled = !0),
              void t.addEventListener('load', function e() {
      ...
      compile: function () {
        ...
        return (
          ...
          e && this.scopeStyles(this.elt, '[' + this.component.getScopeId() + ']'),
          Promise.resolve()
        );
      },
      getContent: function () {
    ...
    (n.prototype = {
      ...
      compile: function (t) {
        var e = function (t) {
            return l.require(u(this.component.baseURI, t));
          }.bind(this),
          n = function (t, e) {
            return l(u(this.component.baseURI, t), e);
          }.bind(this);
        try {
          ...
          if (!('lineNumber' in t)) return Promise.reject(t);
          var i = responseText.replace(/\r?\n/g, '\n'),
            o = i.substr(0, i.indexOf(script)).split('\n').length + t.lineNumber - 1;
          throw new t.constructor(t.message, url, o);
        }
        return Promise.resolve(this.module.exports)
          .then(l.scriptExportsHandler.bind(this))
          .then(
            function (t) {
              this.module.exports = t;
            }.bind(this)
          );
      },
    }),
    (i.prototype = {
      ...
      getRootElt: function () {
        ...
        for (t = t.firstChild; null !== t; t = t.nextSibling) if (t.nodeType === Node.ELEMENT_NODE) return t;
        return null;
      },
      compile: function () {
    ...
    (o.prototype = {
      ...
      getScopeId: function () {
        return (
          '' === this._scopeId &&
            ((this._scopeId = 'data-s-' + (t++).toString(36)),
            this.template.getRootElt().setAttribute(this._scopeId, '')),
          this._scopeId
        );
      },
      load: function (t) {
        return l.httpRequest(t).then(
          function (o) {
            this.baseURI = t.substr(0, t.lastIndexOf('/') + 1);
            var s = document.implementation.createHTMLDocument('');
            s.body.innerHTML = (this.baseURI ? '<base href="' + this.baseURI + '">' : '') + o;
            for (var r = s.body.firstChild; r; r = r.nextSibling)
              switch (r.nodeName) {
                case 'TEMPLATE':
                  this.template = new i(this, r);
                  break;
                case 'SCRIPT':
                  this.script = new n(this, r);
                  break;
                case 'STYLE':
                  this.styles.push(new e(this, r));
              }
            return this;
          }.bind(this)
        );
      ...
      _normalizeSection: function (t) {
        return (null !== t && t.elt.hasAttribute('src')
          ? l.httpRequest(t.elt.getAttribute('src')).then(function (e) {
          ...
          .then(
            function (e) {
              if (null !== t && t.elt.hasAttribute('lang')) {
                ...
                return (
                  t.elt.removeAttribute('lang'),
                  l.langProcessor[n.toLowerCase()].call(this, null === e ? t.getContent() : e)
                );
              }
              return e;
            }.bind(this)
      ...
      return function () {
        return new o(e)
          ...
          .then(function (t) {
            ...
            return (
              null !== t.template && (e.template = t.template.getContent()),
              void 0 === e.name && void 0 !== t.name && (e.name = t.name),
              (e._baseURI = t.baseURI),
              e
            );
          });
      };
    ...
    (l.register = function (t, e) {
      var n = r(e);
      t.component(n.name, l.load(n.url));
    }),
        ...
        beforeCreate: function () {
          ...
          for (var n in e)
            if ('string' == typeof e[n] && 'url:' === e[n].substr(0, 4)) {
              var i = r(e[n].substr(4)),
                o = '_baseURI' in this.$options ? u(this.$options._baseURI, i.url) : i.url;
              isNaN(n) ? (e[n] = l.load(o, n)) : (e[n] = t.component(i.name, l.load(o, i.name)));
            }
        },
      });
    }),
    ...
    (l.langProcessor = { html: s, js: s, css: s }),
    (l.scriptExportsHandler = s),
    l
  );
});
